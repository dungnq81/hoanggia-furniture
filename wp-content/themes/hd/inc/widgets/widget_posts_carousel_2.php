...
/**
 * Class W_Posts_Carousel_2_Widget
 */
class W_Posts_Carousel_2_Widget extends WP_Widget {
	/**
	 * W_Posts_Carousel_2_Widget constructor.
	 */
	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'w_posts_carousel_2',
			'description'                 => __( 'Your site&#8217;s filter posts carousel2 by category.', 'hd' ),
			'customize_selective_refresh' => true,
		);

		parent::__construct( 'w_posts_carousel_2', __( 'W - Posts Carousel 2', 'hd' ), $widget_ops );
		$this->alt_option_name = 'w_posts_carousel_2';
	}
	...
	public function widget( $args, $instance ) {
		...
		?>
        <section id="<?=$this->id?>" class="section grid-post-wrapper posts_carousel <?=$_class?>">
			...
			<a href="<?= esc_url( $view_more_url ) ?>" class="view-all" title="<?php echo esc_attr( $button_name ) ?>">
	...
	public function form( $instance ) {
		...
		<p>
			...
			<span style="display: block;margin-top: 5px;"><?php echo __( 'Các class cách nhau bởi khoảng trắng', 'hd' ); ?></span>
		</p>
	<?php
	}
...
add_action( 'widgets_init', function () {
	register_widget( 'W_Posts_Carousel_2_Widget' );
} );
